...
In both assignments, we use the OpenAI API to generate structured output. You can read more about structured output on the [assignments](assignments/index.qmd) page.
...
- Python code  for generating Anki flashcards: {{<bi file-code >}} [anki-flashcards.zip](assets/anki-flashcards.zip)
