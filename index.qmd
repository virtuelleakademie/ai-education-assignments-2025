...
For both assignments, we provide the following code examples:
...
Python code is provided here: {{<bi download >}} [anki-deck-generator.zip](assets/anki-deck-generator.zip). Installation instructions are provided in the `README.md` file.
...
### Presentation Focus
Your 20-minute presentation should focus on high-level concepts rather than technical implementation details. You do not need to present or explain code during your presentation. Key areas to address include:
...
- Recommended total time investment: ~10 hours
...
- Clarity of your educational approach
...
- Many lecturers are interested in using AI to enhance their teaching
- Most lack technical knowledge to develop their own AI tools
- Wide range of technical abilities among lecturers
- Need for practical, hands-on learning approaches
- Limited time for training (3-hour workshop format)
- Requirement for immediate practical application
...
### Context 
- There's a growing need for quality control in AI-generated educational content
- Ensuring educational effectiveness of AI-generated content is a challenge
- Developing clear quality metrics is crucial
